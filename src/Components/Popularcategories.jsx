        ...
        <div className='popularcategory-container mt-[50px] flex justify-center'>
            <div className='w-[75vw] flex flex-col gap-y-[20px] items-center '>
                ...
                <div className='flex w-[100%] justify-between gap-x-[10px]'>
                    <Categoryboxes image={Motorbike} imagetext="Motorbike" url="/products?category=bike" />
                    <Categoryboxes image={Scooter} imagetext="Scooter" url="/products?category=scooter" />
                    <Categoryboxes image={Threewheel} imagetext="Threewheel" url="/products?category=threewheel" />
                    <Categoryboxes image={Bicycle} imagetext="Bicycle" url="/products?category=bicycle" />
                </div>
            </div>
        </div>
